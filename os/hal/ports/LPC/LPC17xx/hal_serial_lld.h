...
#if (LPC17xx_SERIAL_UART0CLKDIV < 1) || (LPC17xx_SERIAL_UART0CLKDIV > 255)
#error "invalid LPC17xx_SERIAL_UART0CLKDIV setting"
#endif

#if (LPC17xx_SERIAL_UART1CLKDIV < 1) || (LPC17xx_SERIAL_UART1CLKDIV > 255)
#error "invalid LPC17xx_SERIAL_UART1CLKDIV setting"
#endif

#if (LPC17xx_SERIAL_UART2CLKDIV < 1) || (LPC17xx_SERIAL_UART2CLKDIV > 255)
#error "invalid LPC17xx_SERIAL_UART2CLKDIV setting"
#endif

#if (LPC17xx_SERIAL_UART3CLKDIV < 1) || (LPC17xx_SERIAL_UART3CLKDIV > 255)
